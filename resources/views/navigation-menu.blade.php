    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex w-full">
                ...
                <!-- Navigation Links -->
                <div class="hidden sm:-my-px sm:mx-auto sm:flex sm:gap-x-4">
                    <x-nav-link href="{{ route('home') }}" :active="request()->routeIs('home')">
                        {{ __('Home') }} <i class="fa-solid fa-home ps-2"></i>
                    </x-nav-link>
                    <x-nav-link href="{{ route('categories.index') }}" :active="request()->routeIs('categories.index')">
                        {{ __('Categories') }} <i class="fas fa-list ps-2"></i>
                    </x-nav-link>
                    <x-nav-link href="{{ route('publishers.index') }}" :active="request()->routeIs('publishers.index')">
                        {{ __('Publishers') }} <i class="fas fa-table ps-2"></i>
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos() and auth()->check())
                                <button
